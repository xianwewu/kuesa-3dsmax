...
namespace Max2Babylon
{
    public partial class ExporterForm : Form
    {
        ...
        private void kuesaLayers_CheckedChanged_3(object sender, EventArgs e)
        {

        }

        private void kuesaWireFrame_CheckedChanged(object sender, EventArgs e)
        {
